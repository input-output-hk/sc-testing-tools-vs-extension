...
<p align="center">
  <sub>
    <a href="#1-install-the-extension">1. Install the extension</a> &nbsp;·&nbsp;
    <a href="#2-open-your-project">2. Open your project</a> &nbsp;·&nbsp;
    <a href="#3-open-the-pbt-sidebar">3. Open the PBT sidebar</a> &nbsp;·&nbsp;
    <a href="#4-choose-an-execution-mode">4. Choose an execution mode</a> &nbsp;·&nbsp;
    <a href="#5-run-your-tests">5. Run your tests</a> &nbsp;·&nbsp;
    <a href="#6-read-the-results">6. Read the results</a>
  </sub>
</p>
...
> **First Docker run is slow.** PBT pulls the `nixos/nix` image and populates a persistent `pbt-extension-nix-store` volume the first time it runs. Later runs reuse the volume and are much faster.
