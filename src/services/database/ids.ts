...
export const PACKAGE_ID_MAX_LENGTH = WORKSPACE_ID_MAX_LENGTH + 1 + PACKAGE_NAME_MAX_LENGTH; // workspaceId:packageName

export const SUITE_NAME_MAX_LENGTH = 256;
export const SUITE_ID_MAX_LENGTH = PACKAGE_ID_MAX_LENGTH + 1 + SUITE_NAME_MAX_LENGTH; // workspaceId:packageName:suiteName
